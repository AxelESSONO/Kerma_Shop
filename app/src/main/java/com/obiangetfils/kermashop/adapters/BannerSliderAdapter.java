...
public class BannerSliderAdapter extends SliderViewAdapter<BannerSliderAdapter.SliderAdapterVH> {
    ...
    public class SliderAdapterVH extends SliderViewAdapter.ViewHolder {
        ...
        public SliderAdapterVH(View itemView) {
            ...
            imageViewBackground = itemView.findViewById(R.id.iv_image_banner_slider);
            imageGifContainer = itemView.findViewById(R.id.iv_image_gif_container);
            textViewDescription = itemView.findViewById(R.id.tv_auto_description_slider);
